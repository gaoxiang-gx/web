<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      ...
      <el-select clearable @change='handleGroupFilter' style="width: 120px" class="filter-item"
                 v-model="listQuery.support_user_account_group_id" placeholder="客服部门">
        <el-option v-for="item in userGroupOptions" :key="item.group_name" :label="item.group_name"
                   :value="item.id">
        </el-option>
      </el-select>
      <!--<el-select :disabled="productTabSelected" clearable @focus="getGroupTeamList" @change='handleGroupTeamFilter' style="width: 120px" class="filter-item" v-model="listQuery.user_account_group_team_id" placeholder="客服组">-->
    ...
    <el-table :span-method="objectSpanMethod" id="channelTable" :height="tableHeight" show-summary
      ...
      <el-table-column :key="Math.random()" align="center" label="订单数 / 新粉订单数" min-width="80" v-if="!listQuery.is_month">
        <template slot-scope="scope">
