  ...
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      ...
      <el-select clearable @change='handleGroupFilter' style="width: 120px" class="filter-item"
        ...
        <el-option v-for="item in userGroupOptions" :key="item.id" :label="item.group_name"
                   :value="item.id">
        </el-option>
      </el-select>
      <el-select clearable @change='handleGroupFilter' style="width: 120px" class="filter-item"
                 v-model="listQuery.promotion_user_account_group_id" placeholder="推广部门">
...
<script>
  import { getFrontSupportMemberStatistics } from '@/api/support_statistics'
  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        getFrontSupportMemberStatistics(this.listQuery).then(res => {
          const list = []
