    ...
    <div class="filter-container">
      <el-row>
        <el-col :span="20">
          <div>
            <el-date-picker
              v-show="listQuery.query_type_date === true"
              class="filter-item"
              :clearable="false"
            ...
            <el-date-picker
              v-show="listQuery.query_type_date === false"
              format="yyyy-MM"
              :clearable="false"
            ...
            <el-button type="primary" class="filter-item" @click="exportExcel" icon="el-icon-download" v-waves v-if="$store.state.user.roles === 'administrator'">导出Excel</el-button>
            <el-button v-show="listQuery.query_type_date === false"
                       type="primary"
                       class="filter-item"
                       v-waves
          ...
          <template v-for="(item, index) in contrastArray" >
            <div style="float: left;margin-right: 20px;">
              ...
              <el-button type="danger" @click="handleContrastDelete(item,index)" v-waves icon="el-icon-delete"></el-button>
            </div>
          </template>
        </el-col>
        <el-col :span="4">
