        ...
        <el-col :span="20">
          <div>
            <el-select  @change='handleFilter'
                        ...
                        class="filter-item"
                        style="width:150px"
                        @focus="getUserAccountDepartment"
                        :loading="departmentLoading"
                        v-model="listQuery.promotion_user_account_department_id">
            ...
            <el-select clearable
                       ...
                       placeholder="推广组">
              <el-option v-for="item in userGroupOptions2" :key="item.id" :label="item.group_name"
                         :value="item.id">
              </el-option>
            </el-select>
            <el-select clearable
                       ...
                       style="width: 150px"
                       class="filter-item"
                       v-model="listQuery.support_user_account_group_id"
                       placeholder="客服部门">
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        ...
        listQuery: {
          ...
          promotion_user_account_department_id: undefined,
    ...
    methods: {
      getGroupList2() {
        getUserAccountGroupList({ user_account_type_id: 1, user_account_department_id: this.listQuery.promotion_user_account_department_id }).then(response => {
      ...
      getUserAccountDepartment() {
        ...
        getUserAccountDepartmentGroupTree({ user_account_type: 'promote' }).then(res => {
